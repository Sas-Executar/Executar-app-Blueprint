...
**Propósito.** Políticas que restringem o comportamento e as ações permitidas dos agentes.

**O que pertence aqui.** Políticas referenciadas pelo campo `rules`/`limits`/`approvals` do Agent Contract.
