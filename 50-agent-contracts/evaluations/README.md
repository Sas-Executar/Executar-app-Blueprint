...
**Propósito.** Critérios e casos de avaliação de agentes.

**O que pertence aqui.** Casos de teste e critérios de sucesso/falha referenciados pelo campo `evaluations` do Agent Contract.
