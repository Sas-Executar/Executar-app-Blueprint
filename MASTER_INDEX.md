...
|---|---|---|---|---|
| Governance | GOV-*/MASTER-* | docs/00-governance + root | canonicality, precedence, traceability and completion tracking | P0 |
...
| ADR-OMNI-001 | Single Canonical Work State with Omnichannel Adapters | `docs/04-architecture/ADR/ADR-OMNICHANNEL-001.md` | accepted | 1.0.0 | architecture decision for App/MCP/WhatsApp/Email/Copiloto/Mapa-OS+Scanner surfaces |
| SPEC-WORKSPACE-001 | Workspace, Routes and Task Visualization | `docs/09-frontend/SPEC-WORKSPACE-001.md` | pre_approved | 0.9.0 | workspace routes, task modes, single-project/remix and object separation; technical route decisions remain open |
| AGENT-FLOW-001 | Copiloto — Sync, Plan, Pre-Approve, Execute, Reconcile | `docs/05-agent/COPILOT_ORCHESTRATION_FLOW.md` | pre_approved | 0.9.0 | agent orchestration and deliverable-first pre-approval gate |
