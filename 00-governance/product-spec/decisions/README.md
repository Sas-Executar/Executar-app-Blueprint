...
**Propósito.** Decisões registradas fora do formato formal de ADR.

**O que pertence aqui.** Decisões pontuais com classificação `DECISION`, vinculadas às fontes que as originaram.
