...
**Propósito.** Registro de conflitos entre fontes canônicas.

**O que pertence aqui.** Um registro por conflito, seguindo o fluxo `SOURCE_A + SOURCE_B → CONFLICT → DECISION → CANONICAL SPEC` de `80-GOVERNANCE/CONTRIBUTION_RULES.md`. Nenhum conflito deve ser resolvido silenciosamente.
