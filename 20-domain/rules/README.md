...
**Propósito.** Regras de negócio e de domínio do EXECUTAR.

**O que pertence aqui.** Regras com classificação `CONSTRAINT` ou `DECISION`, vinculadas a entidades/capabilities.
