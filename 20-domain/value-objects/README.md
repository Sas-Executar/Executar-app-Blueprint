...
**Propósito.** Objetos de valor imutáveis do domínio (sem identidade própria).

**O que pertence aqui.** Definições de value objects usados pelas entidades e regras de domínio.
