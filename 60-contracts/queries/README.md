...
**Propósito.** Contratos de queries (operações de leitura) do domínio EXECUTAR.

**O que pertence aqui.** Um contrato por query, seguindo a estrutura do Domain Contract em `60-CONTRACTS/entities/DOMAIN_CONTRACT_TEMPLATE.md`.
