...
**Propósito.** Contratos formais de interface de agentes (schema de invocação).

**O que pertence aqui.** Distinto de `50-AGENTS/agents`, que guarda a especificação comportamental completa (Agent Contract).
