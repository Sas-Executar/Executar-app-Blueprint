...
**Propósito.** Camada final do modelo de tokens (`PRIMITIVE → SEMANTIC → COMPONENT`).

**O que pertence aqui.** Tokens de componente (ex.: `button.primary.background`) que consomem tokens semânticos. Ver `30-DESIGN/tokens/TOKEN_MODEL.md`.
