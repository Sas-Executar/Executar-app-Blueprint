...
**Propósito.** Especificação de vídeos do produto EXECUTAR.

**O que pertence aqui.** Referências a vídeos; o contrato completo de cada asset vive em `40-CONTENT/assets/ASSET_CONTRACT_TEMPLATE.md`.
