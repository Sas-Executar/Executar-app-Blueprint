...
**Propósito.** Especificação de imagens do produto EXECUTAR.

**O que pertence aqui.** Referências a imagens; o contrato completo de cada asset vive em `40-CONTENT/assets/ASSET_CONTRACT_TEMPLATE.md`.
