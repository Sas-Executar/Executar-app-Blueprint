...
**Propósito.** Políticas de falha, retry e fallback das integrações.

**O que pertence aqui.** Comportamento esperado em caso de indisponibilidade, timeout ou erro do provider.
