...
**Propósito.** Fontes brutas recebidas, antes de qualquer classificação ou normalização.

**O que pertence aqui.** Documentos originais tal como recebidos, sem edição. Ver fluxo de ingestão em `80-GOVERNANCE/CONTRIBUTION_RULES.md`.
